...
*
*/			
	public class IndividualRender implements IRenderer{
		private var radius:Number = 20;
		private var btnW = 150;
		private var btnH = 55;
		private var fillType:String = "linear";
		private var colors:Array = [0xADF000, 0x00F000];
		...
		public function IndividualRender(){
		...
		public function render(d:DataSprite):void{
			...
			sprite.graphics.lineStyle(0, 0xADF000, 100, true, "none", "square", "round");
