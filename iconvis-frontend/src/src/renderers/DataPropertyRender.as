...
*
*/			
	public class DataPropertyRender implements IRenderer{
		private var radius:Number = 20;
		private var btnW = 150;
		private var btnH = 55;
		private var fillType:String = "linear";
		private var colors:Array = [0x0000FF, 0x0033FF];
		...
		public function DataPropertyRender(){
		...
		public function render(d:DataSprite):void{
			...
			sprite.graphics.lineStyle(0, 0x0000FF, 100, true, "none", "square", "round");
		...
		public function _nodeVisit(n:NodeSprite):void{
			n.renderer=this;
		}
	}
}